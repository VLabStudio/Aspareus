  ...
  <body>
    <?php
        ...
        $UIGenerator->StartClass("GridViewCenterSmall LeftSpacingSmall RightSpacingSmall");
           $UIGenerator->GenerateCustomElementWithClass("p","This is a Aspareus, Aspareus is a system for creating and holding tests for users.","TextStyle");
        $UIGenerator->EndClass();
